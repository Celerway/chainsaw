...
func TestParseLogLevel(t *testing.T) {
	...
	tests := []struct {
		...
		{"tracelevel", args{"traceLevel"}, TraceLevel},
		{"debuglevel", args{"debuglevel"}, DebugLevel},
		{"infolevel", args{"infolevel"}, InfoLevel},
		{"warnlevel", args{"warnlevel"}, WarnLevel},
		{"errorlevel", args{"errorlevel"}, ErrorLevel},
		{"fatallevel", args{"fatallevel"}, FatalLevel},
